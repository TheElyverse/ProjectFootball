...
`docs/pass-candidates.md`, `docs/pass-decisions.md`), tactical phases (`docs/match-phases.md`) with events and diagnostics
...
libs/
  ...
  sim-match      Pitch, ball, perception, decisions, actions, rules            [exists: pitch, state, loop, movement, ball, perception, possession, passing, reception, decisions, events, phases]
