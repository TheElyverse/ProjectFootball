...
.PHONY: help configure build test run ci sanitize format format-check clean
...
help:
	...
	@echo "  ci            Run the same checks CI runs (warnings-as-errors build + tests + format check)"
